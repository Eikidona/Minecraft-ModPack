 ...
 * @param {$IRaidTarget} raidTarget 
 */
function $Raid(id, level, raidTarget) {
    /**
     * @description 标识符
     * @type {number}
     */
...
$Raid.prototype.getCenter = function () {
    return this.raidTarget.getTargetPosition();
}
/**
...
$Raid.prototype.getRaidNameComponent = function () {
    return $Raid.RAID_NAME_COMPONENT;
}
/**
...
$Raid.prototype.getRaidVictoryComponent = function () {
    return $Raid.RAID_BAR_VICTORY_COMPONENT;
}
/**
...
$Raid.prototype.getRaidLossComponent = function () {
    return $Raid.RAID_BAR_DEFEAT_COMPONENT;
}
/**
...
$Raid.prototype.getRaidBossBarColor = function () {
    return this.raidEvent.getColor();
}
/**
...
$Raid.prototype.getRaidBossBarOverlay = function () {
    return this.raidEvent.getOverlay();
}
/**
...
$Raid.prototype.spawnWaves = function () {
    ...
    this.factions.forEach(faction => {
        faction.getFactionEntityTypeWeightTable()
    })
    /**
     * 进行生成 直至本次强度值耗尽
     */
...
$Raid.prototype.tick = function () {
     ...
     */
    if (!this.isStarted()) {
        this.raidEvent.setProgress($Utils.math.clamp((300 - this.cooldownTicks) / 300, 0.0, 1.0));
        this.cooldownTicks--;
    ...
    if (!this.isOver()) {
        ...
        if (totalRaidersAlive > 0) {
            // 更新BossBar值
            this.raidEvent.setProgress($Utils.math.clamp((this.getTotalRaidersAlive() / this.getTotalHealth()) / this.getTotalHealth(), 0.0, 1.0));
